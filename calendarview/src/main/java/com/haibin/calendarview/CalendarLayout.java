    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.e("mrs","-----dy----------"+dy);
                Log.e("mrs","-----mContentView.getTranslationY()----------"+mContentView.getTranslationY());
                Log.e("mrs","-----mContentViewTranslateY----------:"+-mContentViewTranslateY);
                ...
                float c = mContentView.getTranslationY() + dy;
                translationViewPager();
                mLastY = y;
                break;
