...
public class UnitConvertUtil {
		...
		if (preUnit == aftUnit) {
			...
			case LENGTH:
				if (Double.valueOf(inputNum) > 1) {
					...
					mid = computeLength(ArithUtil.getScientificNum(inputNum),
							preUnit, true);
				...
				if (Double.valueOf(mid) > 1) {
					...
					result = computeLength(ArithUtil.getScientificNum(mid), aftUnit,
							false);
			...
			case AREA:
				if (Double.valueOf(inputNum) > 1) {
					...
					mid = computeArea(ArithUtil.getScientificNum(inputNum),
							preUnit, true);
					mid = ArithUtil.mul(mid, ArithUtil.getScientificIndex(inputNum));
				}
				if (Double.valueOf(mid) > 1) {
					...
					result = computeArea(ArithUtil.getScientificNum(mid), aftUnit,
							false);
					result = ArithUtil.mul(result, ArithUtil.getScientificIndex(mid));
				}
				break;
			case VOLUME:
				if (Double.valueOf(inputNum) > 1) {
					...
					mid = computeVolume(ArithUtil.getScientificNum(inputNum),
							preUnit, true);
					mid = ArithUtil.mul(mid, ArithUtil.getScientificIndex(inputNum));
				}
				if (Double.valueOf(mid) > 1) {
					...
					result = computeVolume(ArithUtil.getScientificNum(mid), aftUnit,
							false);
					result = ArithUtil.mul(result, ArithUtil.getScientificIndex(mid));
				}
				break;
			...
			case SPEED:
				if (Double.valueOf(inputNum) > 1) {
					...
					mid = computeSpeed(ArithUtil.getScientificNum(inputNum),
							preUnit, true);
					mid = ArithUtil.mul(mid, ArithUtil.getScientificIndex(inputNum));
				}
				if (Double.valueOf(mid) > 1) {
					...
					result = computeSpeed(ArithUtil.getScientificNum(mid), aftUnit,
							false);
					result = ArithUtil.mul(result, ArithUtil.getScientificIndex(mid));
				}
				break;
			case TIME:
				if (Double.valueOf(inputNum) > 1) {
					...
					mid = computeTime(ArithUtil.getScientificNum(inputNum),
							preUnit, true);
					mid = ArithUtil.mul(mid, ArithUtil.getScientificIndex(inputNum));
				}
				if (Double.valueOf(mid) > 1) {
					...
					result = computeTime(ArithUtil.getScientificNum(mid), aftUnit,
							false);
					result = ArithUtil.mul(result, ArithUtil.getScientificIndex(mid));
				}
				break;
			case MASS:
				if (Double.valueOf(inputNum) > 1) {
					...
					mid = computeMass(ArithUtil.getScientificNum(inputNum),
							preUnit, true);
					mid = ArithUtil.mul(mid, ArithUtil.getScientificIndex(inputNum));
				}
				if (Double.valueOf(mid) > 1) {
					...
					result = computeMass(ArithUtil.getScientificNum(mid), aftUnit,
							false);
					result = ArithUtil.mul(result, ArithUtil.getScientificIndex(mid));
				}
				break;
	...
	private static String computeLength(String inputNum, int unit,
		...
		if (isToStandardUnit) {
			...
			case 0:
				result= ArithUtil.mul(inputNum,"1000");
				break;
				//1:米 y=x;x=y
			case 1:
				result=inputNum;
				...
				//2:分米 y=0.1x;x=10y
			case 2:
				result= ArithUtil.mul(inputNum,"0.1");
				break;
				//3:厘米 y=0.01x;x=100y;
			case 3:
				result= ArithUtil.mul(inputNum,"0.01");
				break;
				//4:毫米 y=0.001x;x=1000y
			case 4:
				result= ArithUtil.mul(inputNum,"0.001");
				break;
				//5:微米 y=0.000001x;x=1000000y
			case 5:
				result= ArithUtil.mul(inputNum,"0.000001");
				break;
				//6:纳米 y=x/1000000000;x=1000000000y;
			case 6:
				result= ArithUtil.div(inputNum,"1000000000");
				break;
				//7:皮米 y=x/1000000000000;x=1000000000000y
			case 7:
				result= ArithUtil.div(inputNum,"1000000000000");
				break;
				//8:海里 y=1852x;x=y/1852
			case 8:
				result= ArithUtil.mul(inputNum,"1852");
				break;
				//9:英里 y=1609.344x;x=y/1609.344
			case 9:
				result= ArithUtil.mul(inputNum,"1609.344");
				break;
				//10:弗隆 y=201.168x;x=y/201.168
			case 10:
				result= ArithUtil.mul(inputNum,"201.168");
				break;
				//11:英寻 y=1.8288x;x=y/1.8288
			case 11:
				result= ArithUtil.mul(inputNum,"1.8288");
				break;
				//12:码 y=0.9144x;x=y/0.9144
			case 12:
				result= ArithUtil.mul(inputNum,"0.9144");
				break;
				//13:英尺 y=0.3048x;x=y/0.3048
			case 13:
				result= ArithUtil.mul(inputNum,"0.3048");
				break;
				//14:英寸 y=0.0254x;x=y/0.0254
			case 14:
				result= ArithUtil.mul(inputNum,"0.0254");
				break;
			...
			case 15:
				...
				//16:里 y=500x;x=y/500
			case 16:
				result= ArithUtil.mul(inputNum,"500");
				break;
				//17:丈 y=10x/3;x=3y/10
			case 17:
				result= ArithUtil.div(ArithUtil.mul(inputNum,"10"),"3");
				break;
				//18:尺	y=1x/3;x=3y
			case 18:
				result= ArithUtil.div(inputNum,"3");
				break;
				//19:寸	y=1x/30;x=30y
			case 19:
				result= ArithUtil.div(ArithUtil.mul(inputNum,"3"),"10");
				break;
				//20:分	y=1x/300;x=300y
			case 20:
				result= ArithUtil.div(ArithUtil.mul(inputNum,"3"),"100");
				break;
				//21:厘	y=1x/3000;x=3000y
			case 21:
				result= ArithUtil.div(ArithUtil.mul(inputNum,"3"),"1000");
				break;
				//22:毫	y=1x/30000;x=30000y
			case 22:
				result= ArithUtil.div(ArithUtil.mul(inputNum,"3"),"10000");
				break;
				//23:秒差距 y=3.08568×10^16x;x=y/3.08568×10^16
			case 23:
				result= ArithUtil.mul(ArithUtil.mul(inputNum,"3.08568"),"10000000000000000");
				break;
				//24:月球距离 y=3.84×10^8x;x=y/3.84×10^8
			case 24:
				result= ArithUtil.mul(ArithUtil.mul(inputNum,"3.84"),"100000000");
				break;
				//25:天文单位  y=149597870700x;x=y/149597870700	
			case 25:
				result= ArithUtil.mul(inputNum,"149597870700");
				break;
				//26:光年单位 y=9460730472580800x;x=y/9460730472580800
			case 26:
				result= ArithUtil.mul(inputNum,"9460730472580800");
				break;
			...
			//0:千米 y=1000x;x=y/1000
			case 0:
				result= ArithUtil.div(inputNum,"1000");
				break;
				//1:米 y=x;x=y
			case 1:
				result=inputNum;
				...
				//2:分米 y=0.1x;x=10y
			case 2:
				result= ArithUtil.mul(inputNum,"10");
				break;
				//3:厘米 y=0.01x;x=100y;
			case 3:
				result= ArithUtil.mul(inputNum,"100");
				break;
				//4:毫米 y=0.001x;x=1000y
			case 4:
				result= ArithUtil.mul(inputNum,"1000");
				...
				//5:微米 y=0.000001x;x=1000000y
			case 5:
				result= ArithUtil.mul(inputNum,"1000000");
				break;
				//6:纳米 y=x/1000000000;x=1000000000y;
			case 6:
				result= ArithUtil.mul(inputNum,"1000000000");
				break;
				//7:皮米 y=x/1000000000000;x=1000000000000y
			case 7:
				result= ArithUtil.mul(inputNum,"1000000000000");
				break;
				//8:海里 y=1852x;x=y/1852
			case 8:
				result= ArithUtil.div(ArithUtil.div(inputNum,"1.852"),"1000");
				break;
				//9:英里 y=1609.344x;x=y/1609.344
			case 9:
				result= ArithUtil.div(ArithUtil.div(inputNum,"1.609344"),"1000");
				break;
				//10:弗隆 y=201.168x;x=y/201.168
			case 10:
				result= ArithUtil.div(ArithUtil.div(inputNum,"2.01168"), "100");
				break;
				//11:英寻 y=1.8288x;x=y/1.8288
			case 11:
				result= ArithUtil.div(inputNum,"1.8288");
				break;
				//12:码 y=0.9144x;x=y/0.9144
			case 12:
				result= ArithUtil.div(inputNum,"0.9144");
				break;
				//13:英尺 y=0.3048x;x=y/0.3048
			case 13:
				result= ArithUtil.div(inputNum,"0.3048");
				break;
				//14:英寸 y=0.0254x;x=y/0.0254
			case 14:
				result= ArithUtil.div(inputNum,"0.0254");
				break;
				//15:公里 y=1000x;x=y/1000
			case 15:
				result= ArithUtil.div(inputNum,"1000");
				...
				//16:里 y=500x;x=y/500
			case 16:
				result= ArithUtil.div(inputNum,"500");
				break;
				//17:丈 y=10x/3;x=3y/10
			case 17:
				result= ArithUtil.div(ArithUtil.mul(inputNum,"3"),"10");
				...
				//18:尺	y=1x/3;x=3y
			case 18:
				result= ArithUtil.mul(inputNum,"3");
				break;
				//19:寸	y=1x/30;x=30y
			case 19:
				result= ArithUtil.mul(inputNum,"30");
				break;
				//20:分	y=1x/300;x=300y
			case 20:
				result= ArithUtil.mul(inputNum,"300");
				break;
				//21:厘	y=1x/3000;x=3000y
			case 21:
				result= ArithUtil.mul(inputNum,"3000");
				break;
				//22:毫	y=1x/30000;x=30000y
			case 22:
				result= ArithUtil.mul(inputNum,"30000");
				break;
				//23:秒差距 y=3.08568×10^16x;x=y/3.08568×10^16
			case 23:
				result= ArithUtil.div(ArithUtil.div(inputNum,"3.08568"),"10000000000000000");
				break;
				//24:月球距离 y=3.84×10^8x;x=y/3.84×10^8
			case 24:
				result= ArithUtil.div(ArithUtil.div(inputNum,"3.84"),"100000000");
				break;
				//25:天文单位  y=149597870700x;x=y/149597870700	
			case 25:
				result= ArithUtil.div(ArithUtil.div(inputNum,"1.495978707"),"100000000000");
				break;
				//26:光年单位 y=9460730472580800x;x=y/9460730472580800
			case 26:
				result= ArithUtil.div(ArithUtil.div(inputNum,"9.4607304725808"),"1000000000000000");
				break;
	...
	private static String computeArea(String inputNum, int unit,
		...
		if (isToStandardUnit) {
			...
			case 1:
				result= ArithUtil.mul(inputNum, "10000");
				break;
				//2:公亩 y=100x;x=y/100
			case 2:
				result= ArithUtil.mul(inputNum, "100");
			...
			case 4:
				result= ArithUtil.div(inputNum, "100");
				break;
				//5:平方厘米 y=x/10000;x=10000y
			case 5:
				result= ArithUtil.div(inputNum, "10000");
				break;
				//6:平方毫米 y=x/10^6;x=10^6*y
			case 6:
				result= ArithUtil.div(inputNum, "1000000");
				break;
			...
			case 8:
				result= ArithUtil.mul(inputNum, "4046.864798");
				break;
				//9:平方英里 y=2589998.11x;x=y/2589998.11
			case 9:
				result= ArithUtil.mul(inputNum, "2589998.11");
				break;
				//10:平方码 y=0.83612736x;x=y/0.83612736
			case 10:
				result= ArithUtil.mul(inputNum, "0.83612736");
				break;
				//11:平方英尺  y=0.09290304x;x=y/0.09290304
			case 11:
				result= ArithUtil.mul(inputNum, "0.09290304");
				break;
				//12:平方英寸 y=0.00064516x;x=y/0.00064516
			case 12:
				result= ArithUtil.mul(inputNum, "0.00064516");
				break;
				//13:平方竿 y=25.2928526x;x=y/25.2928526
			case 13:
				result= ArithUtil.mul(inputNum, "25.2928526");
				break;	
				//14:顷 y=1000000x/15;x=15y/1000000
			case 14:
				result= ArithUtil.div(ArithUtil.mul(inputNum, "100000"), "1.5");
				break;
				//15:亩 y=10000x/15;x=15y/10000
			case 15:
				result= ArithUtil.div(ArithUtil.mul(inputNum, "1000"), "1.5");
				break;
				//16:平方尺 y=x/9;x=9y
			case 16:
				result= ArithUtil.div(inputNum, "9");
				break;
				//17:平方寸 y=x/900;x=900y
			case 17:
				result= ArithUtil.div(ArithUtil.div(inputNum, "9"), "100");
				break;
			...
			case 7:
				...
				//8:英亩  y=4046.864798x;x=y/4046.864798
			case 8:
				result= ArithUtil.div(ArithUtil.div(inputNum, "4.046864798"), "1000");
				break;
				//9:平方英里 y=2589998.11x;x=y/2589998.11
			case 9:
				result= ArithUtil.div(ArithUtil.div(inputNum, "2.58999811"), "1000000");
				break;
				//10:平方码 y=0.83612736x;x=y/0.83612736
			case 10:
				result= ArithUtil.div(inputNum, "0.83612736");
				break;
				//11:平方英尺  y=0.09290304x;x=y/0.09290304
			case 11:
				result= ArithUtil.div(inputNum, "0.09290304");
				break;
				//12:平方英寸 y=0.00064516x;x=y/0.00064516
			case 12:
				result= ArithUtil.div(inputNum, "0.00064516");
				break;
				//13:平方竿 y=25.2928526x;x=y/25.2928526
			case 13:
				result= ArithUtil.div(result= ArithUtil.div(inputNum, "2.52928526"), "10");
				break;	
				//14:顷 y=1000000x/15;x=15y/1000000
			case 14:
				result= ArithUtil.div(ArithUtil.mul(inputNum, "15"), "1000000");
				break;
				//15:亩 y=10000x/15;x=15y/10000
			case 15:
				result= ArithUtil.div(ArithUtil.mul(inputNum, "15"), "10000");
				break;
				//16:平方尺 y=x/9;x=9y
			case 16:
				result= ArithUtil.mul(inputNum, "9");
				break;
				//17:平方寸 y=x/900;x=900y
			case 17:
				result= ArithUtil.mul(inputNum, "900");
				break;
				//18:平方公里  y=10^6x;x=y/10^6
			case 18:
				result= ArithUtil.div(inputNum, "1000000");
	...
	private static String computeVolume(String inputNum, int unit,
		...
		if (isToStandardUnit) {
			...
			case 6:
				result= ArithUtil.mul(inputNum, "0.0001");
				break;
				//7:厘升 y=0.00001x;x=100000y
			case 7:
				result= ArithUtil.mul(inputNum, "0.00001");
				break;
			...
			case 9:
				result= ArithUtil.mul(inputNum, "0.02831685");
				break;
				//10:立方英寸 y=0.000016387064x;x=y/0.000016387064
			case 10:
				result= ArithUtil.mul(inputNum, "0.000016387064");
				break;
				//11:立方码 y=0.76455486x;x=y/0.76455486
			case 11:
				result= ArithUtil.mul(inputNum, "0.76455486");
				break;
				//12:亩英尺 y=1233.4818375x;x=y/1233.4818375
			case 12:
				result= ArithUtil.mul(inputNum, "1233.4818375");
				break;
			...
			case 6:
				...
				//7:厘升 y=0.00001x;x=100000y
			case 7:
				result= ArithUtil.mul(inputNum, "100000");
				break;
				//8:毫升 y=0.000001x;x=1000000y
			case 8:
				result= ArithUtil.mul(inputNum, "1000000");
				...
				//9:立方英尺 y=0.02831685x;x=y/0.02831685
			case 9:
				result= ArithUtil.div(inputNum, "0.02831685");
				break;
				//10:立方英寸 y=0.000016387064x;x=y/0.000016387064
			case 10:
				result= ArithUtil.div(inputNum, "0.000016387064");
				break;
				//11:立方码 y=0.76455486x;x=y/0.76455486
			case 11:
				result= ArithUtil.div(inputNum, "0.76455486");
				break;
				//12:亩英尺 y=1233.4818375x;x=y/1233.4818375
			case 12:
				result= ArithUtil.div(ArithUtil.div(inputNum, "1.2334818375"), "1000");
				break;
	...
	private static String computeTemperature(String inputNum, int unit,
		...
		if (isToStandardUnit) {
			...
			case 1:
				result = ArithUtil.div(ArithUtil.sub(inputNum, "32"), "1.8");
				break;
			// 2:开尔文 y=x+273.15----x=y-273.15
			case 2:
				result = ArithUtil.sub(inputNum, "273.15");
				break;
			// 兰氏度 y=1.8x+32+459.67---x=(y-491.67)/1.8
			case 3:
				result = ArithUtil.div(ArithUtil.sub(inputNum, "491.67"), "1.8");
				break;
			// 列氏度 y=0.8x---x=y/0.8
			case 4:
				result = ArithUtil.div(inputNum, "0.8");
				break;
			...
			// 1:华氏度 y=1.8x+32---x=(y-32)/1.8
			case 1:
				result = ArithUtil.add(ArithUtil.mul(inputNum, "1.8"), "32");
				break;
			// 2:开尔文 y=x+273.15----x=y-273.15
			case 2:
				result = ArithUtil.add(inputNum, "273.15");
				break;
			// 兰氏度 y=1.8x+32+459.67---x=(y-491.67)/1.8
			case 3:
				result = ArithUtil.add(ArithUtil.mul(inputNum, "1.8"), "491.67");
				break;
			// 列氏度 y=0.8x---x=y/0.8
			case 4:
				result = ArithUtil.mul(inputNum, "0.8");
				break;
	...
	private static String computeSpeed(String inputNum, int unit,
		...
		if (isToStandardUnit) {
			...
			case 0:
				result = ArithUtil.mul(inputNum, "299792458");
				break;
			// 1:马赫 y=340.3x;x=y/340.3
			case 1:
				result = ArithUtil.mul(inputNum, "340.3");
				break;
			// 2:米/秒 y=x;x=y
			case 2:
				result = inputNum;
			...
			case 3:
				result = ArithUtil.div(inputNum, "3.6");
				break;
			...
			case 5:
				result = ArithUtil.div(ArithUtil.mul(inputNum, "1.852"), "3.6");
				break;
			// 6:英里/小时 y=1609.344x/3600;x=3600y/1609.344
			case 6:
				result = ArithUtil.div(ArithUtil.mul(inputNum, "1.609344"), "3.6");
				break;
			...
			// 0:光速 y=299792458x;x=y/299792458
			case 0:
				result = ArithUtil.div(ArithUtil.div(inputNum, "2.99792458"),
						"100000000");
				break;
			// 1:马赫 y=340.3x;x=y/340.3
			case 1:
				result = ArithUtil.div(ArithUtil.div(inputNum, "3.403"), "100");
				break;
			// 2:米/秒 y=x;x=y
			case 2:
				result = inputNum;
			...
			// 3:千米/小时 y=1000x/3600;x=y*3.6
			case 3:
				result = ArithUtil.mul(inputNum, "3.6");
				break;
			// 4:千米/秒 y=1000x;x=y/1000;
			case 4:
				result = ArithUtil.div(inputNum, "1000");
			...
			// 5:海里/小时 y=1852x/3600;x=3600y/1852
			case 5:
				result = ArithUtil.div(ArithUtil.mul(inputNum, "3.6"), "1.852");
				break;
			// 6:英里/小时 y=1609.344x/3600;x=3600y/1609.344
			case 6:
				result = ArithUtil.div(ArithUtil.mul(inputNum, "3.6"), "1.609344");
				break;
			// 英尺/秒 y=0.3048x;x=y/0.3048
			case 7:
				result = ArithUtil.div(inputNum, "0.3048");
	...
	private static String computeTime(String inputNum, int unit,
		...
		if (isToStandardUnit) {
			...
			case 0:
				result = ArithUtil.mul(inputNum, "31536000");
				break;
			// 1:周 y=7*24*3600x---x=y/604800
			case 1:
				result = ArithUtil.mul(inputNum, "604800");
				break;
			// 2:天 y=24*3600x---x=y/86400
			case 2:
				result = ArithUtil.mul(inputNum, "86400");
				break;
			// 3.小时 y=3600x---x=y/3600
			case 3:
				result = ArithUtil.mul(inputNum, "3600");
				break;
			// 4.分 y=60x---x=y/60
			case 4:
				result = ArithUtil.mul(inputNum, "60");
				break;
			// 5.秒 y=x---x=y
			case 5:
				result = inputNum;
			...
			// 0:年 y=365*24*3600x---x=y/31536000
			case 0:
				result = ArithUtil.div(ArithUtil.div(inputNum, "3.1536"), "10000000");
				break;
			// 1:周 y=7*24*3600x---x=y/604800
			case 1:
				result = ArithUtil.div( ArithUtil.div(inputNum, "6.048"), "100000");
				break;
			// 2:天 y=24*3600x---x=y/86400
			case 2:
				result = ArithUtil.div(ArithUtil.div(inputNum, "8.64"), "10000");
				break;
			// 3.小时 y=3600x---x=y/3600
			case 3:
				result = ArithUtil.div(ArithUtil.div(inputNum, "3.6"), "1000");
				break;
			// 4.分 y=60x---x=y/60
			case 4:
				result = ArithUtil.div(ArithUtil.div(inputNum, "6"), "10");
				break;
			// 5.秒 y=x---x=y
			case 5:
				result = inputNum;
	...
	private static String computeMass(String inputNum, int unit,
		...
		if (isToStandardUnit) {
			...
			case 6:
				result= ArithUtil.mul(inputNum, "453.59237");
				break;
				//7:盎司 y=453.59237x/16;x=16y/453.59237 1/16磅
			case 7:
				result= ArithUtil.div(ArithUtil.mul(inputNum, "45.359237"), "1.6");
				break;
				//8:克拉 y=0.2x;x=5y;
			case 8:
				result= ArithUtil.mul(inputNum, "0.2");
				break;
				//9:格令 y=453.59237x/7000;x=7000y/453.59237
			case 9:
				result= ArithUtil.div(ArithUtil.mul(inputNum, "0.45359237"), "7");
				break;
				//10:长吨 y=1016046.91x;x=y/1016046.91 2205磅
			case 10:
				result= ArithUtil.mul(inputNum, "1016046.91");
				break;
				//11:短吨 y=907184.74x;x=y/907184.74 2000磅
			case 11:
				result= ArithUtil.mul(inputNum, "907184.74");
				break;
				//12:英担 y=50802.3454x;x=y/50802.3454  112磅
			case 12:
				result= ArithUtil.mul(inputNum, "50802.3454");
				break;
				//13:美担 y=45359.237x;x=y/45359.237	100磅
			case 13:
				result= ArithUtil.mul(inputNum, "45359.237");
				break;
				//14:英石 y=6350.29318x;x=y/6350.29318 14磅
			case 14:
				result= ArithUtil.mul(inputNum, "6350.29318");
				break;
				//15:打兰 y=453.59237x/256;x=256y453.59237   1/256磅
			case 15:
				result= ArithUtil.div(ArithUtil.mul(inputNum, "4.5359237"), "2.56");
				break;
				//16:担  y=50000x;x=y/50000
			case 16:
				result= ArithUtil.mul(inputNum, "50000");
				break;
				//17:斤 y=500x;x=y/500
			case 17:
				result= ArithUtil.mul(inputNum, "500");
			...
			case 18:
				...
				//19:两 y=50x;x=y/50
			case 19:
				result= ArithUtil.mul(inputNum, "50");
				break;
			...
			case 4:
				...
				//5:公担 y=100000x;x=y/100000
			case 5:
				result= ArithUtil.div(inputNum, "100000");
				break;
				//6:磅 y=453.59237x;x=y/453.59237
			case 6:
				result= ArithUtil.div(ArithUtil.div(inputNum, "4.5359237"), "100");
				break;
				//7:盎司 y=453.59237x/16;x=16y/453.59237 1/16磅
			case 7:
				result= ArithUtil.div(ArithUtil.mul(inputNum, "0.16"), "4.5359237");
				break;
				//8:克拉 y=0.2x;x=5y;
			case 8:
				result= ArithUtil.mul(inputNum, "5");
				...
				//9:格令 y=453.59237x/7000;x=7000y/453.59237
			case 9:
				result= ArithUtil.div(ArithUtil.mul(inputNum, "70"), "4.5359237");
				break;
				//10:长吨 y=1016046.91x;x=y/1016046.91 2205磅
			case 10:
				result= ArithUtil.div(ArithUtil.div(inputNum, "1.01604691"), "1000000");
				break;
				//11:短吨 y=907184.74x;x=y/907184.74 2000磅
			case 11:
				result= ArithUtil.div(ArithUtil.div(inputNum, "9.0718474"), "100000");
				break;
				//12:英担 y=50802.3454x;x=y/50802.3454  112磅
			case 12:
				result= ArithUtil.div(ArithUtil.div(inputNum, "5.08023454"), "10000");
				break;
				//13:美担 y=45359.237x;x=y/45359.237	100磅
			case 13:
				result= ArithUtil.div(ArithUtil.div(inputNum, "4.5359237"), "10000");
				break;
				//14:英石 y=6350.29318x;x=y/6350.29318 14磅
			case 14:
				result= ArithUtil.div(ArithUtil.div(inputNum, "6.35029318"), "1000");
				break;
				//15:打兰 y=453.59237x/256;x=256y/453.59237   1/256磅
			case 15:
				result= ArithUtil.div(ArithUtil.mul(inputNum, "2.56"), "4.5359237");
				break;
				//16:担  y=50000x;x=y/50000
			case 16:
				result= ArithUtil.div(inputNum, "50000");
				break;
				//17:斤 y=500x;x=y/500
			case 17:
				result= ArithUtil.div(inputNum, "500");
				...
				//18:钱 y=5x;x=y/5
			case 18:
				result= ArithUtil.div(inputNum, "5");
				break;
				//19:两 y=50x;x=y/50
			case 19:
				result= ArithUtil.div(inputNum, "50");
				break;
